...
public class Quad 
{
	...
	void SetSize(int Height,int Width)
	{
		...
		//Left Down
		m_Vertices[0] = new Vec2(0,0,0,0);
		
		//Right Down
		m_Vertices[1] = new Vec2(m_Width,0,1,0);
		
		//Right Up
		m_Vertices[2] = new Vec2(m_Width,m_Height,1,1);
		
		//Left Up
		m_Vertices[3] = new Vec2(0,m_Height,0,1);	
	...
	void GLUpdateDrawBuffers(Vec2[] Vertex_TexData)
	{
		/*
